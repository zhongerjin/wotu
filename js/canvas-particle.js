var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementById("slider");
		...
		var canvas = {
			...
			config: {
				...
				max_conn: canvasConfig.max_conn || 10
			}
		};
		...
		document.getElementById("slider").onmousemove = function(e){
			var event = e || window.event;
			if(event.target.parentNode.parentNode.id==="charts"||event.target.className==="regbtn") {canvas.mouse = undefined;return;}
